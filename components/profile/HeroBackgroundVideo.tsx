...
export function HeroBackgroundVideo({
  ...
  return (
    <>
      <video
        ref={ref}
        className={`absolute left-1/2 top-0 min-h-[126%] w-full min-w-[104%] -translate-x-1/2 translate-y-[-2.5%] bg-[#030305] object-cover sm:min-h-[132%] ${lightOverlay ? "opacity-[0.94]" : "opacity-[0.82]"}`}
