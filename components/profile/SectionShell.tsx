  ...
  return (
    ...
    >
      <div className="mx-auto max-w-6xl px-4 sm:px-6 lg:px-8">
        <header className="relative mb-9 flex gap-3 sm:gap-4 md:mb-12">
          <div
            className="mt-1 w-px shrink-0 self-stretch rounded-full bg-linear-to-b from-accent/80 via-accent/35 to-transparent min-h-24"
            aria-hidden
          />
